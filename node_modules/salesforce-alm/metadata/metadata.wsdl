...
<definitions targetNamespace="http://soap.sforce.com/2006/04/metadata" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns="http://schemas.xmlsoap.org/wsdl/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:tns="http://soap.sforce.com/2006/04/metadata">
 <types>
  <xsd:schema elementFormDefault="qualified" targetNamespace="http://soap.sforce.com/2006/04/metadata">
   ...
   <xsd:complexType name="FunctionBundle">
    <xsd:complexContent>
     <xsd:extension base="tns:Metadata">
      <xsd:sequence>
       <xsd:element name="apiVersion" minOccurs="0" type="xsd:double"/>
       <xsd:element name="appName" minOccurs="0" type="xsd:string"/>
       <xsd:element name="checkSum" type="xsd:string"/>
       <xsd:element name="description" minOccurs="0" type="xsd:string"/>
       <xsd:element name="endpoint" minOccurs="0" type="xsd:string"/>
       <xsd:element name="label" minOccurs="0" type="xsd:string"/>
       <xsd:element name="sdkVersion" minOccurs="0" type="xsd:string"/>
       <xsd:element name="type" minOccurs="0" type="xsd:string"/>
      </xsd:sequence>
     </xsd:extension>
    </xsd:complexContent>
    ...
    <xsd:complexContent>
     <xsd:extension base="tns:Metadata">
      <xsd:sequence>
       ...
       <xsd:element name="password" minOccurs="0" type="xsd:string"/>
       <xsd:element name="principalType" type="tns:ExternalPrincipalType"/>
       <xsd:element name="privateConnection" minOccurs="0" type="xsd:string"/>
       <xsd:element name="protocol" type="tns:AuthenticationProtocol"/>
       <xsd:element name="username" minOccurs="0" type="xsd:string"/>
      </xsd:sequence>
     </xsd:extension>
   ...
   <xsd:complexType name="PrivateConnection">
    <xsd:complexContent>
     <xsd:extension base="tns:Metadata">
      <xsd:sequence>
       <xsd:element name="description" minOccurs="0" type="xsd:string"/>
       <xsd:element name="direction" type="tns:PrivateConnectionDirection"/>
       <xsd:element name="externalConnectionProperties" minOccurs="0" maxOccurs="unbounded" type="tns:ExternalConnectionProperty"/>
       <xsd:element name="label" type="xsd:string"/>
       <xsd:element name="status" type="tns:PrivateConnectionStatus"/>
       <xsd:element name="type" type="tns:PrivateConnectionType"/>
      </xsd:sequence>
     </xsd:extension>
    </xsd:complexContent>
   </xsd:complexType>
   <xsd:simpleType name="PrivateConnectionDirection">
    <xsd:restriction base="xsd:string">
     <xsd:enumeration value="Inbound"/>
     <xsd:enumeration value="Outbound"/>
    </xsd:restriction>
   </xsd:simpleType>
   <xsd:complexType name="ExternalConnectionProperty">
    <xsd:sequence>
     <xsd:element name="propertyName" type="tns:ConnectionPropertyName"/>
     <xsd:element name="propertyValue" type="xsd:string"/>
    </xsd:sequence>
   </xsd:complexType>
   <xsd:simpleType name="ConnectionPropertyName">
    <xsd:restriction base="xsd:string">
     <xsd:enumeration value="LinkId"/>
     <xsd:enumeration value="AwsVpcEndpointId"/>
     <xsd:enumeration value="AwsVpcEndpointServiceName"/>
    </xsd:restriction>
   </xsd:simpleType>
   <xsd:simpleType name="PrivateConnectionStatus">
    <xsd:restriction base="xsd:string">
     <xsd:enumeration value="Disabled"/>
     <xsd:enumeration value="Enabled"/>
     <xsd:enumeration value="Incomplete"/>
     <xsd:enumeration value="PendingAvailability"/>
     <xsd:enumeration value="PendingApproval"/>
     <xsd:enumeration value="Refresh"/>
    </xsd:restriction>
   </xsd:simpleType>
   <xsd:simpleType name="PrivateConnectionType">
    <xsd:restriction base="xsd:string">
