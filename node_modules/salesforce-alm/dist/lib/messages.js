...
const messages = {
    ...
    package_install: {
        en_US: {
            ...
            promptRss: 'This package might send or receive data from these third-party websites:\n\n' +
                '%s' +
                '\n\nGrant access (y/n)?',
            promptUpgradeType: 'Please confirm usage of the --upgradetype Delete operation. This can result in the loss of data associated with the deleted components. Proceed with caution.' +
                '\n\nProceed (y/n)?',
            promptUpgradeTypeDeny: 'The installation has been canceled because confirmation was not granted for the --upgradetype Delete operation. ' +
            ...
            apexCompileLong: 'For unlocked packages only, specifies whether to compile all Apex in the org and package, or only the Apex in the package.',
    ...
    package_version_create: {
        en_US: {
            ...
            errorProfileUserLicensesInvalidValue: "The value specified for includeProfileUserLicenses '%s' is invalid.  It must be a boolean true/false value.",
