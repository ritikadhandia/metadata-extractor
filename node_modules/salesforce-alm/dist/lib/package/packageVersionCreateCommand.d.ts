declare class PackageVersionCreateCommand {
    ...
    _deleteInactiveFlows(activeFlow: any, flowFiles: any, packageVersMetadataFolder: any): {
        promises: any;
        flows: any[];
    };
    _filterOutInactiveFlows(packageVersMetadataFolder: any): any;
    /**
    ...
    _pollForStatus(context: any, id: any, retries: any, packageId: any): any;
    /**
