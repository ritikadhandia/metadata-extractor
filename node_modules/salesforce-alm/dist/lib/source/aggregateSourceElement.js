...
class AggregateSourceElement {
    ...
    commitMetadata(newPaths, updatedPaths, deletedPaths, dupPaths, manifest) {
    ...
    commitContent(newPaths, updatedPaths, deletedPaths, dupPaths, unsupportedMimeTypes) {
    ...
    getPaths(metadataFilePath, container, decompositions) {
        ...
        for (const decomposedSubtypeConfig of decompositions.keys()) {
            for (const decomposition of decompositions.get(decomposedSubtypeConfig)) {
                const sourceDir = this.workspaceStrategy.getDecomposedSubtypeDirFromMetadataFile(metadataFilePath, this.metadataType.getExt(), decomposedSubtypeConfig);
