...
class MdapiPushApi extends sourceDeployApiBase_1.SourceDeployApiBase {
    ...
    async processResults(result, changedAggregateSourceElements) {
        try {
        ...
        if (result.success && result.status === 'Succeeded') {
            ...
            if (result.timedOut) {
                ...
                deployFailed.failures = syncCommandHelper.getDeployFailures(result, aggregateSourceElements, this.metadataRegistry, logger);
            }
    ...
    async _postProcess(result) {
        ...
        if (field === sourceUtil_1.RevisionCounterField.RevisionNum) {
            return result;
        }
        else {
