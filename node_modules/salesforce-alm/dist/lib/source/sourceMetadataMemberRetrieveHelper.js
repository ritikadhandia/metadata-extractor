...
class SourceMetadataMemberRetrieveHelper {
    ...
    getLatestSourceRevisionCount() {
        const query = `SELECT MAX(${sourceUtil_1.getRevisionFieldName()}) maxRev from SourceMember`;
    ...
    getRevisionsAsPackage(fromRevision, obsoleteNames) {
        ...
        const revisionFieldName = sourceUtil_1.getRevisionFieldName();
