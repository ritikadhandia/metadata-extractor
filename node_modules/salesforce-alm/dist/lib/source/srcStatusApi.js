...
class SrcStatusApi extends kit_1.AsyncCreatable {
    ...
    populateServerChanges(options) {
        ...
        return srcDevUtil
            ...
            return this.force.toolingFind(this.scratchOrg, 'SourceMember', { [sourceUtil_1.getRevisionFieldName()]: { $gt: maxRevision } }, ['MemberType', 'MemberName', 'IsNameObsolete']);
        })
            .then(sourceMembers => {
    ...
    createRemoteChangeElementsFromSourceMember(sourceMember) {
        const remoteChangeElements = [];
        const sourceMemberMetadataType = metadataTypeFactory_1.MetadataTypeFactory.getMetadataTypeFromMetadataName(sourceMember.MemberType, this.swa.metadataRegistry);
        if (sourceMemberMetadataType) {
            if (sourceMemberMetadataType.trackRemoteChangeForSourceMemberName(sourceMember.MemberName)) {
                const correspondingWorkspaceElements = this.getCorrespondingWorkspaceElements(sourceMember, sourceMemberMetadataType);
    ...
    getCorrespondingWorkspaceElements(sourceMember, sourceMemberMetadataType) {
