...
const functionBundleMetadataType_1 = require("./metadataTypeImpl/functionBundleMetadataType");
...
class MetadataTypeFactory {
                ...
                if (!metadataType) {
                    switch (typeDefName) {
                        ...
                        case typeDefObjs.Flow.metadataName:
                            ...
                            break;
                        case typeDefObjs.FunctionBundle.metadataName:
                            metadataType = new functionBundleMetadataType_1.FunctionBundleMetadataType(typeDefObj);
                            break;
    ...
    static getMetadataTypeFromMdapiPackagePath(packagePath, metadataRegistry) {
        ...
        if (pathElements.length > 1) {
            ...
            const isTerritory2Model = typeDef && typeDef.metadataName === metadataRegistry.typeDefs.Territory2Model.metadataName;
