...
export declare abstract class SourceDeployApiBase extends AsyncCreatable<SourceDeployApiBase.Options> {
     ...
     * @returns {any}
     */
    getOutboundFiles(aggregateSourceElements: Map<String, AggregateSourceElement>, isDelete?: boolean): any[];
    /**
     ...
     * @returns {any}
     */
    convertAndDeploy(options: any, sourceWorkspaceAdapter: any, aggregateSourceElements: Map<string, AggregateSourceElement>, createDestructiveChanges: boolean): Promise<any>;
    /**
     * Remove source elements that failed to deploy
     * @param componentFailures
     * @param aggregateSourceElements
     */
    removeFailedAggregates(componentFailures: any, deployedSourceElements: Map<String, AggregateSourceElement>): void;
    /**
