...
export declare class AggregateSourceElement {
     ...
     */
    constructor(aggregateMetadataType: MetadataType, aggregateFullName: any, aggregateMetadataFilePath: any, metadataRegistry: any);
    getMetadataType(): MetadataType;
    static getKeyFromMetadataNameAndFullName(aggregateMetadataName: any, aggregateFullName: any): string;
    getKey(): string;
    /**
    ...
    addWorkspaceElement(workspaceElement: any): void;
    /**
     ...
     * @returns {Array[]}
     */
    commit(manifest: any, unsupportedMimeTypes: string[]): [string[], string[], string[]];
    /**
