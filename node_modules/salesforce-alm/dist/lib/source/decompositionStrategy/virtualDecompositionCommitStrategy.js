...
class VirtualDecompositionCommitStrategy extends fineGrainTrackingCommitStrategy_1.FineGrainTrackingCommitStrategy {
    ...
    commit(documents, existingPaths, createDuplicates) {
        let newPaths;
        let deletedPaths;
        let updatedPaths;
        let dupPaths = [];
        [newPaths, updatedPaths, deletedPaths, dupPaths] = super.commit(documents, existingPaths, createDuplicates /** generateDuplicates */);
