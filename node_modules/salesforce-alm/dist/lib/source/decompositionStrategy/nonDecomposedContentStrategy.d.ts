...
export declare class NonDecomposedContentStrategy implements ContentDecompositionStrategy {
    ...
    saveContent(metadataFilePath: string, retrievedContentFilePaths: string[], retrievedMetadataFilePath: string, createDuplicates: boolean, unsupportedMimeTypes: string[]): [string[], string[], string[], string[]];
    private static filesAreEqual;
}
